                    ...
                    <div className="mx-auto max-w-screen-xl px-4 md:px-8">
                        ...
                        <div className="grid grid-cols-2 gap-4 ml-72 md:grid-cols-3 lg:gap-8">
                            ...
                            <div className="flex flex-col items-center justify-center rounded-lg bg-gray-100 px-8 lg:p-8">
                                <div className="text-xl font-bold text-red-500 sm:text-2xl md:text-3xl">200<img className='inline-flex h-8 w-8 pb-1' src="https://cdn-icons-png.flaticon.com/128/4325/4325956.png" alt="Streak" /></div>
