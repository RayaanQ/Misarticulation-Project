      ...
      <div className="bg-white pt-14 pl-60">
                <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
                    <div className="flex flex-col items-center">
                        ...
                        <a href="/user/quiz" className="inline-block rounded-lg bg-red-400 px-12 py-3 text-center text-sm font-semibold text-white outline-none ring-red-300 transition duration-100 hover:bg-red-500 focus-visible:ring active:text-white md:text-base">Start Quiz</a>
                    </div>
                </div>
            </div>
      <Footer />
