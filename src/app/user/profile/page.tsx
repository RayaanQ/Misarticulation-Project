...
const Profile = () => {
  ...
  return (
    <section
      id="profile"
      className="flex-grow p-6 ml-[300px]"
    >
      {/* Page Heading */}
      <h1 className="h1-style mb-8">Profile</h1>
      {/* Loading Spinner */}
      {/* {user && <AiOutlineLoading className="animate-spin h-12 w-12 mx-auto" />} */}
      {/* Profile Info */}
      <div className="box-container-style mb-8 flex flex-col sm:flex-row items-center gap-4">
        <div className="w-32 h-32 bg-primary rounded-full flex justify-center items-center uppercase font-bold text-6xl text-white bg-gradient-to-r from-green-600 to-green-800">
          {firstLetter}
        </div>
